...
export default function  CardFlip({
  title = 'Services',
  subtitle = 'Hoever On Card to see our services',
  description = 'We Offer modern digital marketing and website',
  features = [
    'SEO',
  ...
  return (
    <div
      className="group relative h-[360px] w-full max-w-[300px] [perspective:2000px] inset-shadow-sm inset-shadow-indigo-500 rounded-2xl"
    ...
    >
      ...
      >
        ...
        <div className="from-primary/5 dark:from-primary/10 absolute inset-0 bg-gradient-to-br via-transparent to-blue-500/5 dark:to-blue-500/10 bg-gray-800" />
              ...
              {[...Array(6)].map((_, i) => (
                <div
                  ...
                  className={cn(
                    ...
                    'from-blue-500/20 via-blue-500/30 to-blue-500/20 bg-gradient-to-r',
          ...
          <div className="absolute right-0 bottom-0 left-0 p-5">
            <div className="flex items-center justify-between gap-3">
              <div className="space-y-1.5">
                <h3 className="text-lg leading-snug font-semibold tracking-tight text-white transition-all duration-500 ease-out group-hover:translate-y-[-4px] dark:text-white">
                  {title}
                </h3>
                <p className="line-clamp-2 text-sm tracking-tight text-blue-400 transition-all delay-[50ms] duration-500 ease-out group-hover:translate-y-[-4px] dark:text-zinc-300">
                  {subtitle}
                </p>
              </div>
              <div className="group/icon relative">
                ...
                />
                <Zap className="text-white relative z-10 h-5 w-5 transition-all duration-300 group-hover/icon:scale-110 group-hover/icon:rotate-12" />
              </div>
            </div>
          </div>
        </div>
