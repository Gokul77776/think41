      ...
      >
        <motion.div className="flex w-full flex-col items-center justify-between lg:flex-row lg:items-start">
          <div className="w-full lg:w-auto">
            ...
            >
              A Digital Markter <br className="hidden sm:inline" />
          ...
          <div className="mt-6 flex flex-col items-center lg:mt-0 lg:items-end">
            ...
            >
              I'M  a skilled digital marketer and web developer with a passion for crafting impactful online experiences.
I combines creative strategy with technical expertise to help businesses grow in the digital world.
Dedicated and results-driven, I consistently delivers innovative solutions tailored to client needs.
            </motion.p>
            <motion.div
              variants={itemVariants}
